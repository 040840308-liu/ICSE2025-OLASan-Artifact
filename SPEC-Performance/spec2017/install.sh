...
#  Copyright 1998-2017 by Standard Performance Evaluation Corporation
#
#  Authors:  Christopher Chan-Nui, Cloyce D. Spradling
#
# $Id: install.sh 5481 2017-03-09 17:40:43Z CloyceS $
#
...
Error running runcpu tests.  See $testout for details,
